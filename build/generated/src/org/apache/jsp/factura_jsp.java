...
public final class factura_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    location.href = 'formfactura.jsp?ID=0&Accion=';\n");
      out.write("                });\n");
      out.write("\n");
      out.write("            });\n");
      out.write("        </script>\n");
      ...
      out.write("\n");
      out.write("                        <h1>Listado de Facturas</h1>\n");
      ...
      out.write("                            <thead>\n");
      out.write("                                <tr>\n");
      out.write("                                    <th>Factura Numero</th>\n");
      out.write("                                    <th>Numero de linea</th>\n");
      out.write("                                    <th>Fecha Emision</th>\n");
      ...
      out.write("                                ");
                                    ...
                                    FacturaDAO obj2 = new FacturaDAO();
                                    try {
                                        ...
                                        while (resul.next()) {
                                            String html = "<tr>";
                                            html += "<td>" + resul.getInt("FACNUMERO") + "</td>";
                                            html += "<td>" + resul.getString("LINUMEROLINEA") + "</td>";
                                            html += "<td>" + resul.getString("FACFECHAEMISION") + "</td>";
                                            html += "<td>" + resul.getString("FACVALOR") + "</td>";
                                            html += "<td><a href='formfactura.jsp?ID=" + resul.getString("FACNUMERO") + "&Accion=Editar'>Editar</a></td>";
                                            html += "<td><a href='formfactura.jsp?ID=" + resul.getString("FACNUMERO") + "&Accion=Eliminar'>Eliminar</a></td>";
                                            html += "</tr>";
                                            out.print(html);
                                        }
                                    } catch (Exception ex) {
