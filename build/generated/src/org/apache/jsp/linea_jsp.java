...
public final class linea_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    location.href = 'formlinea.jsp?ID=0&Accion=';\n");
      out.write("                });\n");
      out.write("            });\n");
      out.write("        </script>\n");
      out.write("        </script>\n");
      ...
      out.write("                        <h1>Listado de Lineas</h1>\n");
      ...
      out.write("                            <thead>\n");
      out.write("                                <tr>\n");
      out.write("                                    <th>Numero de linea</th>\n");
      out.write("                                    <th>Per Id</th>\n");
      out.write("                                    <th>Estado de linea</th>\n");
      ...
      out.write("                                ");
                                    ...
                                    try {
                                        ...
                                        while (resul.next()) {
                                            String html = "<tr>";
                                            html += "<td>" + resul.getInt("LINUMEROLINEA") + "</td>";
                                            html += "<td>" + resul.getString("PERID") + "</td>";
                                            html += "<td>" + resul.getString("LINESTADO") + "</td>";
                                            html += "<td><a href='formlinea.jsp?ID=" + resul.getString("LINUMEROLINEA") + "&Accion=Editar'>Editar</a></td>";
                                            html += "<td><a href='formlinea.jsp?ID=" + resul.getString("LINUMEROLINEA") + "&Accion=Eliminar'>Eliminar</a></td>";
                                            html += "</tr>";
                                            out.print(html);
                                        }
                                    } catch (Exception ex) {
